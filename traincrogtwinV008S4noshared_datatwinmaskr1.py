...
from model.modelV008S4noshared_twinmaskr1 import CROG_TWIN
...
def get_parser():
    ...
    parser.add_argument('--config',
                        default='/home/lbycdy/work/crog_lb/config/OCID-VLG/20240818swincrogV008S4noshared_datatmaskr1type2_multiple_r50.yaml',
                        type=str,
                        help='config file')
