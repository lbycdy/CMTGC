...
from engine.crog_swin_engine import train_with_grasp, validate_with_grasp, validate_without_grasp
from model.modelV003S8s16s32noshared_twin import CROG_TWIN
...
def get_parser():
    ...
    parser.add_argument('--config',
                        default='config/OCID-VLG/20240813swincrogV003S8S16S32noshared_datatwinr1_multiple_r50.yaml',
                        type=str,
                        help='config file')
